...
{
    [TestClass]
    public class DemystifyTest : SeleniumTest
    {

        [TestMethod]
        public void TestDemystify()
        {
            this.TestSuiteRunner.RunInAllBrowsers(this, browser =>
                  {
                      Program(() => Start());
                  }, null, null, 0);
        }
        ...
        void Program()
        {
            var a = new Action(() => Start());
        }

        [MethodImpl(MethodImplOptions.NoOptimization | MethodImplOptions.NoInlining)]
        void Program(Action action) => RunAction((state) => _action((s) => action(), state), null);
...
#pragma warning restore IDE0039 // Use local function
        ...
        [MethodImpl(MethodImplOptions.NoOptimization | MethodImplOptions.NoInlining)]
        static string RefMethod(string value)
        {
            var val = value;
